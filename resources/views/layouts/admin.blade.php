...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex h-screen">
        ...
        <!-- Sidebar -->
        <aside id="sidebar"
            class="bg-indigo-600 text-white w-64 h-full fixed lg:relative transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out overflow-y-auto max-h-screen">
            <div class="p-6">
                ...
                <ul class="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="{{route('admin.student')}}" class="block px-4 py-2 rounded hover:bg-indigo-700">
                            <i class="fas fa-users mr-2"></i> Student Request
                        </a>
                    </li>
                    <li>
                        <a href="{{route('admin.agency')}}" class="block px-4 py-2 rounded hover:bg-indigo-700">
                            <i class="fas fa-users mr-2"></i> Agency Request
                        </a>
                    </li>
                    <li>
                        <a href="{{route('admin.visa_offers')}}" class="block px-4 py-2 rounded hover:bg-indigo-700">
                            <i class="fas fa-users mr-2"></i> Visa Package
                        </a>
                    </li>
                    <li>
                        <a href="#" class="block px-4 py-2 rounded hover:bg-indigo-700">
